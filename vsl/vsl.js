document.addEventListener('DOMContentLoaded', () => {
    ...
    // Configuração do Botão Delay (Liberação da oferta aos 05:48:03)
    const DELAY_MINUTES = 5;
    const DELAY_SECONDS = 48;
    const DELAY_MS      = 3;
    const TOTAL_DELAY_MS = ((DELAY_MINUTES * 60) + DELAY_SECONDS) * 1000 + DELAY_MS;
    ...
    if (delayedOffer) {
        ...
        const SECONDS_TO_DISPLAY = (DELAY_MINUTES * 60) + DELAY_SECONDS + (DELAY_MS / 1000);
